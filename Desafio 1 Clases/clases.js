...
const usuario1 = new Usuario ("Nicolas", "Jofre", [],
    [{tipo:"Perro", nombre:"Teo"}, {tipo:"Gato", nombre:"Orion"}]
);
...
usuario1.addLibro({nombre: "El señor de los anillos: La comunidad del anillo", autor: "J.R.R Tolkien"})
usuario1.addLibro({nombre: "En las montañas de la locura", autor: "H.P. Lovecraft"})
